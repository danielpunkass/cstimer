...
<li><strong data="opt_wndStat">Tilastopaneelin tyyli</strong>. Make list times panel embedded into background.</li>
<li><strong data="opt_wndTool">Työkalut-paneelin tyyli</strong>. Make tool panel embedded into background.</li>
...
<li><strong data="opt_color">valitse väriteema</strong>. Select color schemes of csTimer. Click csTimer's logo to show more color schemes.</li>
...
<li><strong data="opt_scrSize">Sekoituksen pituus</strong>. Size of the scramble text.</li>
...
<li><strong data="opt_scrMono">tasalevyinen sekoitus</strong>. Use monospaced font for scramble text.</li>
<li><strong data="opt_scrLim">Rajoita sekoitusalueen korkeutta</strong>. When the scramble area is too high, a scroll bar will occur to avoid the raising of the scramble panel.</li>
<li><strong data="opt_scrAlign">Sekoitusalueen tasaus</strong>. Alignment of the whole scramble area, include scramble type selector.</li>
...
<li><strong data="opt_scrFast">Käytä nopeaa sekoitusta 4 x 4 x 4 (Epävirallinen)</strong>. WCA official 4x4x4 scramble requires huge computation resources, select this option to use a random-move scramble for 4x4x4 instead.</li>
<li><strong data="opt_scrKeyM">Merkkaa avainsiirto(avainsiirrot) sekoituksessa</strong>. Mark a key move in the scramble, e.g. the move that take the state away from square shape in SQ1 scrambles.</li>
...
<li><strong data="opt_useKSC">käytä pikanäppäimiä</strong>. Use keyboard shortcut to switch scramble type, generate next scramble, switch between sessions. Click csTimer's logo to show details.</li>
...
<li><strong data="tool_cross">Solvers &gt; Risti</strong>. Cross solver, which solve DF, DL, DR, DB edges.</li>
